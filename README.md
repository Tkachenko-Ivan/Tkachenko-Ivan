...
Кстати, в [релизах](https://github.com/Tkachenko-Ivan/Tetris/releases) есть скомпилированные файлы, - можно скачать и запустить .exe чтобы поиграться, а ещё есть вики проекта с описанием как это всё устроено: 📘 [Описание работы программы]([https://github.com/Tkachenko-Ivan/newsseacher/wiki/Хватит-ждать-индексации:-делаем-данные-доступными-для-поиска-мгновенно-на-Manticore-Search](https://github.com/Tkachenko-Ivan/Tetris/wiki/Описание-работы-программы).
